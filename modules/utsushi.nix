...
, imagemagick, sane-backends, tesseract4, udev, libusb, autoconf-archive, libxslt}:
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitLab{
    owner = pname;
    repo = "utsushi";
    rev = "ca4586c56d29814df283b8322cc9edecfd892280";
    sha256 = "15wiqbdajasjw5qvbx08k9gzr7bv4linrbbwzzli8w38y8bcyffd";
  };
